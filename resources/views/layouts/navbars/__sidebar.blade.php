            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('home') }}">
                        <i class="ni ni-world text-default "></i> <span class="text-white">{{ __('Tablero') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('profile.edit') }}">
                        <i class="ni ni-circle-08 text-danger"></i> <span class="text-white"> {{ __('Mi perfil') }} </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('user.index') }}">
                        <i class="ni ni-circle-08 text-primary"></i> <span class="text-white">{{ __('Administracion de usuarios') }} </span>
                    </a>
                </li>
