                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            ...
                            <small>{{ __('Llena los datos para completar el formulario') }}</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Correo eléctronico') }}" type="email" name="email" value="{{ old('email') }}" value="" required autofocus>
                                </div>
                                @if ($errors->has('email'))
